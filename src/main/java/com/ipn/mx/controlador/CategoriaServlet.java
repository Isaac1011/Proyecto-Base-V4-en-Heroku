...
public class CategoriaServlet extends HttpServlet {
    ...
    private void actualizarCategoria(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            dto = dao.read(dto);
            request.setAttribute("dto", dto);//Este se usa en categoriaForm.jsp
            RequestDispatcher rd = request.getRequestDispatcher("/categoria/categoriaForm.jsp");
            rd.forward(request, response);
        } catch (SQLException | ServletException | IOException ex) {
            Logger.getLogger(CategoriaServlet.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void eliminarCategoria(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            dto = dao.read(dto);
            dao.delete(dto);
            listadoCategorias(request, response);//Mostramos el listado
    ...
    private void almacenarCategoria(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (request.getParameter("txtId").isEmpty()) {//Si está vacío el campo de ID, creamos la categoria
        ...
        } else {//Si está vacío el campo de ID NO está vacío, lo actualizamos
            dto.getEntidad().setNombreCategoria(request.getParameter("txtNombre"));
            dto.getEntidad().setDescripcionCategoria(request.getParameter("txtDescripcion"));
    ...
    private void mostrarReporte(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            reporte = new File(getServletConfig().getServletContext().getRealPath("/reportes/MiReporteEstados.jasper"));
